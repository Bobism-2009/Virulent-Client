...
4) Put these jars in mods:
   ...
   - virulent-client-1.10.11.jar
     (from this project: build\libs\virulent-client-1.10.11.jar)
...
1) virulent-client-1.10.11.jar
   Path: build\libs\virulent-client-1.10.11.jar
   Do NOT send:
   - virulent-client-1.10.11-sources.jar
   - anything from run\
...
Output:
  build\libs\virulent-client-1.10.11.jar
...
5) Sent the sources jar
   Use virulent-client-1.10.11.jar, not -sources.jar.
...
[ ] virulent-client-1.10.11.jar in mods
