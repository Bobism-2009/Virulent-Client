...
4) Put these jars in mods:
   ...
   - virulent-client-1.10.4.jar
     (from this project: build\libs\virulent-client-1.10.4.jar)
...
1) virulent-client-1.10.4.jar
   Path: build\libs\virulent-client-1.10.4.jar
   Do NOT send:
   - virulent-client-1.10.4-sources.jar
   - anything from run\
...
Output:
  build\libs\virulent-client-1.10.4.jar
...
5) Sent the sources jar
   Use virulent-client-1.10.4.jar, not -sources.jar.
...
[ ] virulent-client-1.10.4.jar in mods
